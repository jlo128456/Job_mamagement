...
class User(db.Model):
    ...
    def to_dict(self): return {
        "id": self.id, "email": self.email, "role": self.role, "contractor": self.contractor
    }
...
class Job(db.Model):
    ...
    required_date = db.Column(DateTime(timezone=True))
    completion_date = db.Column(DateTime(timezone=True))
    status_timestamp = db.Column(DateTime(timezone=True))
    onsite_time = db.Column(DateTime(timezone=True))
